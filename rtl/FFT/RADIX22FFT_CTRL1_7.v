// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\RADIX22FFT_CTRL1_7.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_CTRL1_7
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
    ...
    case ( SDFController_rdState)
      2'b00 :
        begin
          ...
          rd_7_Enb_1 = 1'b0;
          if (dinXTwdl_7_1_vld && (SDFController_wrCount == 3'b111)) begin

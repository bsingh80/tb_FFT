// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\SDFCommutator1.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_SDF1_1/SDFCommutator1
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator1
  ...
  reg signed [16:0] wrData_im;  // sfix17_En13
    ...
    case ( SDFCummutator_mem_btf_switch)
      ...
      2'b01 :
        begin
          SDFCummutator_mem_btf_switch_next = 2'b01;
          SDFCummutator_rdEnb_xmem_next = 1'b0;
          if ((SDFCummutator_rdCnt == 9'b111111111) && btf_vld) begin

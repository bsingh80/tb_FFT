// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\SDFCommutator10.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_SDF2_10/SDFCommutator10
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator10
  ...
  input   enb;
  input   dout_9_1_vld;
  input   signed [25:0] xf_re;  // sfix26_En13
  input   signed [25:0] xf_im;  // sfix26_En13
  input   xf_vld;
  input   signed [25:0] dinf_re;  // sfix26_En13
  input   signed [25:0] dinf_im;  // sfix26_En13
  input   dinf_vld;
  input   signed [25:0] btf1_re;  // sfix26_En13
  input   signed [25:0] btf1_im;  // sfix26_En13
  input   signed [25:0] btf2_re;  // sfix26_En13
  input   signed [25:0] btf2_im;  // sfix26_En13
  input   btfout_vld;
  output  signed [25:0] wrData_re;  // sfix26_En13
  output  signed [25:0] wrData_im;  // sfix26_En13
  output  wrAddr;  // ufix1
  output  wrEnb;
  ...
  reg signed [25:0] SDFCummutator_out_re;  // sfix26
  reg signed [25:0] SDFCummutator_out_im;  // sfix26
  reg  SDFCummutator_out_vld;
  reg  SDFCummutator_wrAddr_reg;  // ufix1
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg signed [25:0] SDFCummutator_wrData_re_reg;  // sfix26
  reg signed [25:0] SDFCummutator_wrData_im_reg;  // sfix26
  reg  SDFCummutator_wrEnb_reg;
  reg signed [25:0] SDFCummutator_wrXData_re_reg;  // sfix26
  reg signed [25:0] SDFCummutator_wrXData_im_reg;  // sfix26
  ...
  reg signed [25:0] SDFCummutator_btf1_re_dly;  // sfix26
  reg signed [25:0] SDFCummutator_btf1_im_dly;  // sfix26
  reg  SDFCummutator_btf1_vld_dly;
  reg signed [25:0] SDFCummutator_out_re_next;  // sfix26_En13
  reg signed [25:0] SDFCummutator_out_im_next;  // sfix26_En13
  reg  SDFCummutator_out_vld_next;
  reg  SDFCummutator_wrAddr_reg_next;  // ufix1
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [25:0] SDFCummutator_wrData_re_reg_next;  // sfix26_En13
  reg signed [25:0] SDFCummutator_wrData_im_reg_next;  // sfix26_En13
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [25:0] SDFCummutator_wrXData_re_reg_next;  // sfix26_En13
  reg signed [25:0] SDFCummutator_wrXData_im_reg_next;  // sfix26_En13
  ...
  reg signed [25:0] SDFCummutator_btf1_re_dly_next;  // sfix26_En13
  reg signed [25:0] SDFCummutator_btf1_im_dly_next;  // sfix26_En13
  reg  SDFCummutator_btf1_vld_dly_next;
  reg signed [25:0] wrData_re_1;  // sfix26_En13
  reg signed [25:0] wrData_im_1;  // sfix26_En13
  reg  wrAddr_1;  // ufix1
  reg  wrEnb_1;
  reg signed [25:0] xData_re;  // sfix26_En13
  reg signed [25:0] xData_im;  // sfix26_En13
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [25:0] dout0_re;  // sfix26_En13
  reg signed [25:0] dout0_im;  // sfix26_En13
  reg  dout0_vld;
  wire signed [25:0] xX_re;  // sfix26_En13
  wire signed [25:0] xX_im;  // sfix26_En13
  reg signed [25:0] SDFOutmux_btf2Pipe_re;  // sfix26
  reg signed [25:0] SDFOutmux_btf2Pipe_im;  // sfix26
  reg  SDFOutmux_btfPipe_vld;
  reg signed [25:0] SDFOutmux_btf2Pipe_re_next;  // sfix26_En13
  reg signed [25:0] SDFOutmux_btf2Pipe_im_next;  // sfix26_En13
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [25:0] dout_10_1_re_1;  // sfix26_En13
  reg signed [25:0] dout_10_1_im_1;  // sfix26_En13
  reg  dout_10_1_vld_1;
  ...
  always @(posedge clk or posedge reset)
    begin : SDFCummutator_process
      if (reset == 1'b1) begin
        ...
        SDFCummutator_btf1_re_dly <= 26'sb00000000000000000000000000;
        SDFCummutator_btf1_im_dly <= 26'sb00000000000000000000000000;

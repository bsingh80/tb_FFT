// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\SDFCommutator9.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_SDF1_9/SDFCommutator9
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator9
  ...
  input   enb;
  input   din_9_vld_dly;
  input   signed [24:0] xf_re;  // sfix25_En13
  input   signed [24:0] xf_im;  // sfix25_En13
  input   xf_vld;
  input   signed [24:0] dinXTwdlf_re;  // sfix25_En13
  input   signed [24:0] dinXTwdlf_im;  // sfix25_En13
  input   dinxTwdlf_vld;
  input   signed [24:0] btf1_re;  // sfix25_En13
  input   signed [24:0] btf1_im;  // sfix25_En13
  input   signed [24:0] btf2_re;  // sfix25_En13
  input   signed [24:0] btf2_im;  // sfix25_En13
  input   btf_vld;
  output  signed [24:0] wrData_re;  // sfix25_En13
  output  signed [24:0] wrData_im;  // sfix25_En13
  output  wrAddr;  // ufix1
  output  wrEnb;
  ...
  reg signed [24:0] SDFCummutator_out_re;  // sfix25
  reg signed [24:0] SDFCummutator_out_im;  // sfix25
  reg  SDFCummutator_out_vld;
  reg  SDFCummutator_wrAddr_reg;  // ufix1
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg signed [24:0] SDFCummutator_wrData_re_reg;  // sfix25
  reg signed [24:0] SDFCummutator_wrData_im_reg;  // sfix25
  reg  SDFCummutator_wrEnb_reg;
  reg signed [24:0] SDFCummutator_wrXData_re_reg;  // sfix25
  reg signed [24:0] SDFCummutator_wrXData_im_reg;  // sfix25
  ...
  reg signed [24:0] SDFCummutator_out_re_next;  // sfix25_En13
  reg signed [24:0] SDFCummutator_out_im_next;  // sfix25_En13
  reg  SDFCummutator_out_vld_next;
  reg  SDFCummutator_wrAddr_reg_next;  // ufix1
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [24:0] SDFCummutator_wrData_re_reg_next;  // sfix25_En13
  reg signed [24:0] SDFCummutator_wrData_im_reg_next;  // sfix25_En13
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [24:0] SDFCummutator_wrXData_re_reg_next;  // sfix25_En13
  reg signed [24:0] SDFCummutator_wrXData_im_reg_next;  // sfix25_En13
  ...
  reg signed [24:0] wrData_re_1;  // sfix25_En13
  reg signed [24:0] wrData_im_1;  // sfix25_En13
  reg  wrAddr_1;  // ufix1
  reg  wrEnb_1;
  reg signed [24:0] xData_re;  // sfix25_En13
  reg signed [24:0] xData_im;  // sfix25_En13
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [24:0] dout0_re;  // sfix25_En13
  reg signed [24:0] dout0_im;  // sfix25_En13
  reg  dout0_vld;
  wire signed [24:0] xX_re;  // sfix25_En13
  wire signed [24:0] xX_im;  // sfix25_En13
  reg signed [24:0] SDFOutmux_btf2Pipe_re;  // sfix25
  reg signed [24:0] SDFOutmux_btf2Pipe_im;  // sfix25
  reg  SDFOutmux_btfPipe_vld;
  reg signed [24:0] SDFOutmux_btf2Pipe_re_next;  // sfix25_En13
  reg signed [24:0] SDFOutmux_btf2Pipe_im_next;  // sfix25_En13
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [24:0] dout_9_1_re_1;  // sfix25_En13
  reg signed [24:0] dout_9_1_im_1;  // sfix25_En13
  reg  dout_9_1_vld_1;
  ...
  always @(posedge clk or posedge reset)
    begin : SDFCummutator_process
      if (reset == 1'b1) begin
        SDFCummutator_out_re <= 25'sb0000000000000000000000000;
        SDFCummutator_out_im <= 25'sb0000000000000000000000000;
        SDFCummutator_wrData_re_reg <= 25'sb0000000000000000000000000;
        SDFCummutator_wrData_im_reg <= 25'sb0000000000000000000000000;
        SDFCummutator_wrEnb_reg <= 1'b0;
        SDFCummutator_out_vld <= 1'b0;
        SDFCummutator_wrState <= 3'b000;
        SDFCummutator_wrAddr_reg <= 1'b0;
        SDFCummutator_wrXData_re_reg <= 25'sb0000000000000000000000000;
        SDFCummutator_wrXData_im_reg <= 25'sb0000000000000000000000000;
  ...
  always @(SDFCummutator_XState, SDFCummutator_out_im, SDFCummutator_out_re,
    ...
    case ( SDFCummutator_XState)
      3'b000 :
        begin
          SDFCummutator_wrXData_re_reg_next = 25'sb0000000000000000000000000;
          SDFCummutator_wrXData_im_reg_next = 25'sb0000000000000000000000000;
  ...
  always @(posedge clk or posedge reset)
    begin : SDFOutmux_process
      if (reset == 1'b1) begin
        SDFOutmux_btf2Pipe_re <= 25'sb0000000000000000000000000;
        SDFOutmux_btf2Pipe_im <= 25'sb0000000000000000000000000;

// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\RADIX22FFT_CTRL1_1.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_CTRL1_1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
    ...
    case ( SDFController_rdState)
      2'b00 :
        begin
          ...
          rd_1_Enb_1 = 1'b0;
          if (dinXTwdl_1_1_vld && (SDFController_wrCount == 9'b111111111)) begin

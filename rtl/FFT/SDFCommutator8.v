// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\SDFCommutator8.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_SDF2_8/SDFCommutator8
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator8
  ...
  input   enb;
  input   dout_7_1_vld;
  input   signed [23:0] xf_re;  // sfix24_En13
  input   signed [23:0] xf_im;  // sfix24_En13
  input   xf_vld;
  input   signed [23:0] dinf_re;  // sfix24_En13
  input   signed [23:0] dinf_im;  // sfix24_En13
  input   dinf_vld;
  input   signed [23:0] btf1_re;  // sfix24_En13
  input   signed [23:0] btf1_im;  // sfix24_En13
  input   signed [23:0] btf2_re;  // sfix24_En13
  input   signed [23:0] btf2_im;  // sfix24_En13
  input   btfout_vld;
  output  signed [23:0] wrData_re;  // sfix24_En13
  output  signed [23:0] wrData_im;  // sfix24_En13
  ...
  reg signed [23:0] SDFCummutator_out_re;  // sfix24
  reg signed [23:0] SDFCummutator_out_im;  // sfix24
  reg  SDFCummutator_out_vld;
  reg [1:0] SDFCummutator_wrAddr_reg;  // ufix2
  reg [2:0] SDFCummutator_wrState;  // ufix3
  reg signed [23:0] SDFCummutator_wrData_re_reg;  // sfix24
  reg signed [23:0] SDFCummutator_wrData_im_reg;  // sfix24
  reg  SDFCummutator_wrEnb_reg;
  reg signed [23:0] SDFCummutator_wrXData_re_reg;  // sfix24
  reg signed [23:0] SDFCummutator_wrXData_im_reg;  // sfix24
  ...
  reg signed [23:0] SDFCummutator_out_re_next;  // sfix24_En13
  reg signed [23:0] SDFCummutator_out_im_next;  // sfix24_En13
  reg  SDFCummutator_out_vld_next;
  reg [1:0] SDFCummutator_wrAddr_reg_next;  // ufix2
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [23:0] SDFCummutator_wrData_re_reg_next;  // sfix24_En13
  reg signed [23:0] SDFCummutator_wrData_im_reg_next;  // sfix24_En13
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [23:0] SDFCummutator_wrXData_re_reg_next;  // sfix24_En13
  reg signed [23:0] SDFCummutator_wrXData_im_reg_next;  // sfix24_En13
  ...
  reg signed [23:0] wrData_re_1;  // sfix24_En13
  reg signed [23:0] wrData_im_1;  // sfix24_En13
  reg [1:0] wrAddr_1;  // ufix2
  reg  wrEnb_1;
  reg signed [23:0] xData_re;  // sfix24_En13
  reg signed [23:0] xData_im;  // sfix24_En13
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [23:0] dout0_re;  // sfix24_En13
  reg signed [23:0] dout0_im;  // sfix24_En13
  reg  dout0_vld;
  wire signed [23:0] xX_re;  // sfix24_En13
  wire signed [23:0] xX_im;  // sfix24_En13
  reg signed [23:0] SDFOutmux_btf2Pipe_re;  // sfix24
  reg signed [23:0] SDFOutmux_btf2Pipe_im;  // sfix24
  reg  SDFOutmux_btfPipe_vld;
  reg signed [23:0] SDFOutmux_btf2Pipe_re_next;  // sfix24_En13
  reg signed [23:0] SDFOutmux_btf2Pipe_im_next;  // sfix24_En13
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [23:0] dout_8_1_re_1;  // sfix24_En13
  reg signed [23:0] dout_8_1_im_1;  // sfix24_En13
  reg  dout_8_1_vld_1;

// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\TWDLROM_3_1.v
...
// 
// Module: TWDLROM_3_1
// Source Path: tb_FFT/DUT/FFT/TWDLROM_3_1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module TWDLROM_3_1
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    if (dout_2_1_vld && (Radix22TwdlMapping_cnt > 8'b11111110)) begin
      Radix22TwdlMapping_phase_next = Radix22TwdlMapping_phase + 2'b01;
    end
    if (dout_2_1_vld) begin
      Radix22TwdlMapping_cnt_next = Radix22TwdlMapping_cnt + 8'b00000001;
    end

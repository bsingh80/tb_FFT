// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\SDFCommutator7.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_SDF1_7/SDFCommutator7
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator7
  ...
  input   enb;
  input   din_7_vld_dly;
  input   signed [22:0] xf_re;  // sfix23_En13
  input   signed [22:0] xf_im;  // sfix23_En13
  input   xf_vld;
  input   signed [22:0] dinXTwdlf_re;  // sfix23_En13
  input   signed [22:0] dinXTwdlf_im;  // sfix23_En13
  input   dinxTwdlf_vld;
  input   signed [22:0] btf1_re;  // sfix23_En13
  input   signed [22:0] btf1_im;  // sfix23_En13
  input   signed [22:0] btf2_re;  // sfix23_En13
  input   signed [22:0] btf2_im;  // sfix23_En13
  input   btf_vld;
  output  signed [22:0] wrData_re;  // sfix23_En13
  output  signed [22:0] wrData_im;  // sfix23_En13
  ...
  reg signed [22:0] SDFCummutator_out_re_next;  // sfix23_En13
  reg signed [22:0] SDFCummutator_out_im_next;  // sfix23_En13
  reg  SDFCummutator_out_vld_next;
  reg [2:0] SDFCummutator_wrAddr_reg_next;  // ufix3
  reg [2:0] SDFCummutator_wrState_next;  // ufix3
  reg signed [22:0] SDFCummutator_wrData_re_reg_next;  // sfix23_En13
  reg signed [22:0] SDFCummutator_wrData_im_reg_next;  // sfix23_En13
  reg  SDFCummutator_wrEnb_reg_next;
  reg signed [22:0] SDFCummutator_wrXData_re_reg_next;  // sfix23_En13
  reg signed [22:0] SDFCummutator_wrXData_im_reg_next;  // sfix23_En13
  ...
  reg signed [22:0] wrData_re_1;  // sfix23_En13
  reg signed [22:0] wrData_im_1;  // sfix23_En13
  reg [2:0] wrAddr_1;  // ufix3
  reg  wrEnb_1;
  reg signed [22:0] xData_re;  // sfix23_En13
  reg signed [22:0] xData_im;  // sfix23_En13
  reg [2:0] wrXAddr;  // ufix3
  reg  wrXEnb;
  reg [2:0] rdXAddr;  // ufix3
  reg  xX_vld;
  reg signed [22:0] dout0_re;  // sfix23_En13
  reg signed [22:0] dout0_im;  // sfix23_En13
  reg  dout0_vld;
  wire signed [22:0] xX_re;  // sfix23_En13
  wire signed [22:0] xX_im;  // sfix23_En13
  reg signed [22:0] SDFOutmux_btf2Pipe_re;  // sfix23
  reg signed [22:0] SDFOutmux_btf2Pipe_im;  // sfix23
  reg  SDFOutmux_btfPipe_vld;
  reg signed [22:0] SDFOutmux_btf2Pipe_re_next;  // sfix23_En13
  reg signed [22:0] SDFOutmux_btf2Pipe_im_next;  // sfix23_En13
  reg  SDFOutmux_btfPipe_vld_next;
  reg signed [22:0] dout_7_1_re_1;  // sfix23_En13
  reg signed [22:0] dout_7_1_im_1;  // sfix23_En13
  reg  dout_7_1_vld_1;

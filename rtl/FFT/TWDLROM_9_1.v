// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\TWDLROM_9_1.v
...
// 
// Module: TWDLROM_9_1
// Source Path: tb_FFT/DUT/FFT/TWDLROM_9_1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module TWDLROM_9_1
  ...
  input   enb;
  input   dout_8_1_vld;
  output  signed [15:0] twdl_9_1_re;  // sfix16_En14
  output  signed [15:0] twdl_9_1_im;  // sfix16_En14
  ...
  reg  twdl45Reg;
  reg signed [15:0] twdl_9_1_re_1;  // sfix16_En14
  reg signed [15:0] twdl_9_1_im_1;  // sfix16_En14
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_dvldReg1,
    ...
    if (dout_8_1_vld && (Radix22TwdlMapping_cnt > 8'b10111111)) begin
      Radix22TwdlMapping_phase_next = Radix22TwdlMapping_phase + 2'b01;
    end
    if (dout_8_1_vld) begin
      Radix22TwdlMapping_cnt_next = Radix22TwdlMapping_cnt + 8'b01000000;
    end

// -------------------------------------------------------------
// 
// File Name: hdlsrc\tb_FFT\RADIX22FFT_CTRL1_6.v
...
// Source Path: tb_FFT/DUT/FFT/RADIX22FFT_CTRL1_6
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
    ...
    case ( SDFController_rdState)
      2'b00 :
        begin
          ...
          rd_6_Enb_1 = 1'b0;
          if (dout_5_1_vld && (SDFController_wrCount == 4'b1111)) begin
